...
# Caminho para o arquivo de pesos do TransReID
TRANSREID_MODEL_PATH = r"TransReID\pesos\vit_base.pth" 
# (Opcional) Caminho para um arquivo .yml de configuração base do TransReID
TRANSREID_CONFIG_FILE = None # Não é necessário se configurarmos manualmente
